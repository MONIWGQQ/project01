...
public:
	...
	void detect(Mat& frame, vector<BoxInfo>&);
private:
	int inpWidth;
	int inpHeight;
	int nout;
...
void YOLOV7_face::detect(Mat& frame, vector<BoxInfo>& generate_boxes)
{
	Mat dstimg;
...
YOLOV7_face* get_yolo_face_network(Net_config config){
    // string modelPath = "/home/cscw/Desktop/yolov7/onnx_havepost_models/yolov7-w6-face.onnx";
	// Net_config YOLOV7_face_cfg = { 0.45, 0.5, modelPath };
	YOLOV7_face *net = new YOLOV7_face(config);
    return net;
}
// int main()
// {
// 	string modelPath = "/home/cscw/Desktop/yolov7/onnx_havepost_models/yolov7-lite-e.onnx";
// 	Net_config YOLOV7_face_cfg = { 0.45, 0.5, modelPath };
// 	YOLOV7_face net(YOLOV7_face_cfg);
// 	// string imgpath = "/home/cscw/Desktop/yolov7/selfie.jpg";
// 	// Mat srcimg = imread(imgpath);
// 	// net.detect(srcimg);
// 	// 打开视频文件
// 	cv::VideoCapture cap("/home/cscw/Desktop/yolov7/persons.flv");
